...
Use this when mamba-ssm is not available.
"""
...
class MambaMock(nn.Module):
    ...
    def __init__(self, d_model: int, d_state: int = 16, d_conv: int = 4, expand: int = 2, **kwargs):
        ...
        self.d_conv = d_conv  # Added for compatibility
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # FIX: Clone tensor to force new memory layout and avoid cuDNN errors
        # The contiguous() + clone() ensures cuDNN-compatible memory layout
